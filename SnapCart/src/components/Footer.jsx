...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-t from-red-500 via-orange to-orange-500 text-white text-center flex flex-col md:flex-row gap-6 md:gap-10 items-center justify-between px-6 py-8 md:py-6">
            ...
            <div className='flex flex-row justify-between gap-16'>
                <ul className="flex-col gap-4 text-s cursor-pointer text-left">
                    ...
                    <li className="hover:underline transition duration-300 hover:scale-125 ">Store Locations</li>
