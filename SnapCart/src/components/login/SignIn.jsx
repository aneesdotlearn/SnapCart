          ...
          <div className="relative rounded-lg border border-white/80 bg-white/90 p-5 shadow-[0_30px_90px_rgba(88,28,135,.22)] backdrop-blur md:p-8">
            ...
            <div className="relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="w-full gap-3 rounded-lg bg-orange-500 px-1 py-[1px] text-lg font-black items-center justify-center text-white shadow-[0_16px_36px_rgba(249,115,22,.55)] transition hover:bg-purple-800">
                  <GoogleLogin
